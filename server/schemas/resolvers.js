...
const resolvers = {
  ...
  Mutation: {
    addUser: async (parent, { userType, firstName, lastName, email, password, streetAdress, city, state, zip }) => {
      const user = await User.create({ userType, firstName, lastName, email, password, streetAdress, city, state, zip });
